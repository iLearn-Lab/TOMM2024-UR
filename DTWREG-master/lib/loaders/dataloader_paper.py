...
class DataLoader(Loader):
    ...
    def __init__(self, data_json, data_h5, sub_obj_wds, similarity, opt, sent_extract):
        ...
        self.sents_att = json.load(open(osp.join('/home/share2/zpp/REC/DTWREG_CLIP/cache/sent_color_wordid',
                                                 opt['dataset'] + '_' + opt['splitBy'], opt['dataset']+ '_sent_to_color_id.json' ) ) )
        # old
        # self.sents_att = json.load(open(osp.join('/home/share2/zpp/REC/DTWREG_CLIP/cache/sent_color_wordid',
