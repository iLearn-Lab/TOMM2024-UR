    ...
    while True:
        ...
        for i, sent_id in enumerate(sent_ids):
            ...
            if pred_ann_id == gd_ann_id:
                save_path = osp.join('/home/share2/zpp/DTWREG_cp/res_img/refcoco_testA/yes1',save_img_name)
                cv2.imwrite(save_path, img)
            elif pred_ann_id != gd_ann_id and IoU >= 0.5:
                save_path = osp.join('/home/share2/zpp/DTWREG_cp/res_img/refcoco_testA/yes2', save_img_name)
                cv2.imwrite(save_path, img)
            else:
                save_path = osp.join('/home/share2/zpp/DTWREG_cp/res_img/refcoco_testA/no', save_img_name)
                cv2.imwrite(save_path, img)
