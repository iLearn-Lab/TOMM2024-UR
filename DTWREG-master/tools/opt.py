...
def parse_opt():
    ...
    parser.add_argument('--weight_decay', type=float, default=0.0005, help='weight decay for adam') # Evaluation/Checkpointing
    parser.add_argument('--alpha', type=float, default=0, help='') # Evaluation/Checkpointing
