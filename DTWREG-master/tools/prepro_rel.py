...
def get_sub_obj_rel(vocab_dict, refer, params, vocab_list):
    ...
    for sent in sents:
        ...
        if r5 != 'none':
          r5 = prep_process(r5)
          if r5 in vocab_dict:
            rel_wordid = vocab_dict[r5]  #相对关系

        elif r4 != 'none':
          r4 = prep_process(r4)
          if r4 in vocab_dict:
            rel_wordid = vocab_dict[r4]  #位置

        elif r2 != 'none':
          if r2 in vocab_dict:
            rel_wordid = vocab_dict[r2]  #颜色

        elif r3 != 'none':
          if r3 in vocab_dict:
            rel_wordid = vocab_dict[r3]  #大小
        ...
        if (sub_wordid!=3) and (obj_wordid==3):   #只有主语，没有宾语，则设为主语宾语同一个
