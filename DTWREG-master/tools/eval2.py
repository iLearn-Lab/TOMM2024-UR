...
def evaluate(params):
    ...
    # set up loader
    data_json = osp.join('/home/share1/zpp/Mattnet/cache/prepro', params['dataset_splitBy'], 'data.json')
    data_h5 = osp.join('/home/share1/zpp/Mattnet/cache/prepro', params['dataset_splitBy'], 'data.h5')
    ...
    loader.prepare_mrcn(head_feats_dir=osp.join('/home/share1/zpp/Mattnet/cache/feats/', model_opt['dataset_splitBy'], 'mrcn', feats_dir),
                        args=args)
    ann_feats = osp.join('/home/share1/zpp/Mattnet/cache/feats', model_opt['dataset_splitBy'], 'mrcn',
