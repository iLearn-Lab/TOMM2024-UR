...
def main(args):
    ...
    # set up loader
    data_json = osp.join('/home/share1/zpp/Mattnet/cache/prepro', opt['dataset_splitBy'], 'data.json')
    data_h5 = osp.join('/home/share1/zpp/Mattnet/cache/prepro', opt['dataset_splitBy'], 'data.h5')
    ...
    head_feats_dir = osp.join('/home/share1/zpp/Mattnet/cache/feats/', opt['dataset_splitBy'], 'mrcn', feats_dir)

    loader.prepare_mrcn(head_feats_dir, args)

    ann_feats = osp.join('/home/share1/zpp/Mattnet/cache/feats', opt['dataset_splitBy'], 'mrcn',
